...
roslib.load_manifest('dashgo_bringup')


from dashgo_bringup.srv import *
...
class BaseController:
    def __init__(self, arduino, base_frame):
        ...
        rospy.Service('ultrasonic', ultrasonic, self.handle_ultrsonic)
    ...
    def handle_ultrsonic(self,data):
        try:
